<div class="method--bankdata">
    <div class="debit">
        <p class = "none" >
            <input id = "card-holder" type = "text" size = "20" class = "text" value = "{$paymillCardHolder}"  placeholder="{s namespace=frontend/paym_payment_creditcard/checkout/form name=label_creditcard_holder}Credit Card Holder{/s} *"/>
        </p >
        <p class = "none" >
            <input id = "card-number" type = "text" size = "20" class = "text" value = "{$paymillCardNumber}"  placeholder="{s namespace=frontend/paym_payment_creditcard/checkout/form name=label_creditcard_cardnumber}Credit Card Number{/s} *"/>
        </p >
        <p class = "none" >
            <input id = "card-cvc" type = "text" size = "4" class = "text" value = "{$paymillCvc}" placeholder="{s namespace=frontend/paym_payment_creditcard/checkout/form name=label_creditcard_cvc}CVC{/s} *" />
