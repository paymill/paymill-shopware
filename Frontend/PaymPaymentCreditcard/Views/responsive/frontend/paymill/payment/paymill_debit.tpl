<div class="method--bankdata">
    <div class="debit">
        <p class = "none" >
            <input id = "paymill_accountholder" type = "text" size = "20" class = "text" value = "{$paymillAccountHolder}" placeholder="{s namespace=frontend/paym_payment_creditcard/checkout/form name=label_directdebit_accountholder}Account Holder{/s} *" />
        </p >
        <p class = "none" >
