...
Ext.define('Shopware.apps.PaymillOrderOperations.view.main.Panel', {
            ...
            Ext.create('Ext.panel.Panel', {
                ...
                items:     [
                    Ext.create('Ext.grid.Panel', {
                        ...
                        columns:   [
                            {
                                header:    '{s namespace=backend/paym_payment_creditcard/order_operations name=column_label_date}Date{/s}',
                                dataIndex: 'entryDate',
                                flex:      1
                            },
                            {
                                header:    '{s namespace=backend/paym_payment_creditcard/order_operations name=column_label_transaction}Transaction{/s}',
                                dataIndex: 'description',
                                flex:      4
                            },
                            {
                                header:    '{s namespace=backend/paym_payment_creditcard/order_operations name=column_label_amount}Amount{/s}',
                                dataIndex: 'amount',
                                flex:      1
                            }
                        ]
        ...
        Ext.Ajax.request({
            ...
            success: function (response)
            {
                ...
                if (decodedResponse.success) {
                    messageText = "{s namespace=backend/paym_payment_creditcard/order_operations name=feedback_capture_success}Transaction captured successfully.{/s}";
                } else {
                    messageText = "{s namespace=backend/paym_payment_creditcard/order_operations name=feedback_capture_failure}Transaction could not be captured: {/s}";
    ...
    displayButtons: function ()
    {
        ...
        button.push(Ext.create('Ext.Button', {
            text:     '{s namespace=backend/paym_payment_creditcard/order_operations name=button_label_refund}Refund{/s}',
            scale:    'medium',
        ...
        button.push(Ext.create('Ext.Button', {
            text:     '{s namespace=backend/paym_payment_creditcard/order_operations name=button_label_capture}Capture{/s}',
            scale:    'medium',
