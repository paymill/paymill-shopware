...
abstract class FastCheckoutHelperAbstract
{
    ...
    {
        return "CREATE TABLE IF NOT EXISTS `paymill_fastCheckout` (" . "`id` int(11) NOT NULL AUTO_INCREMENT," . "`userId` varchar(250) COLLATE utf8_unicode_ci NOT NULL," . "`clientId` varchar(250) COLLATE utf8_unicode_ci NOT NULL," . "`ccPaymentId` varchar(250) COLLATE utf8_unicode_ci NULL," . "`elvPaymentId` varchar(250) COLLATE utf8_unicode_ci NULL," . "PRIMARY KEY (`id`)," . "UNIQUE KEY `userId` (`userId`)" . ") ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1";
    }
}
